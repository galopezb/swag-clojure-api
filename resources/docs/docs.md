...
Request middleware functions are located under the `swag-clojure-api.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `swag-clojure-api.dev-middleware` namespace found in
